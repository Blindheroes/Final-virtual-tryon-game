...
class BodyScanner:
    def __init__(self):
        ...
        self.body_type = None
        self.gender = "male"  # Default gender, will be updated in start_scan
    ...
    def start_scan(self, gender="male"):
        """Start the scanning process"""
        self.scan_started = True
        self.scan_start_time = time.time()
        self.body_type = None
        self.gender = gender  # Update gender from main application
    ...
    def scan(self, frame):
        ...
        if results.pose_landmarks:
            ...
            if hasattr(self.mp_pose.PoseLandmark, 'LEFT_SHOULDER') and hasattr(self.mp_pose.PoseLandmark, 'RIGHT_SHOULDER'):
                ...
                self.measurements["shoulder_width"] = int(
                    shoulder_width_pixels * 0.2)  # Simplified conversion
        ...
        if scan_complete and self.body_type is None:
            ...
            self.body_type = random.choice(self.body_types[self.gender])
